(()=>{
  ...
  const isEnglish=()=>safe(()=>window.KGGDeviceTestStorage.getItem(LANG_KEY)==='en')===true;
  ...
  function exercisePainMode(ei){
    ...
    const settings=safe(()=>JSON.parse(window.KGGDeviceTestStorage.getItem('kggPatientExerciseSettingsV1')||'{}'))||{};
